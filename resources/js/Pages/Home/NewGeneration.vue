...
<template>
  <section class="bg-[#3a2000] text-white py-12">
    <div class="mx-auto px-4 md:hidden">
      <!-- Slide image -->
      ...
      <div class="space-y-6 mb-14">
        <div class="text-2xl">
          <h4 class="text-box-yellow-light font-medium tracking-widest">
            {{ slideNumber }}
          </h4>
          <h2 class="text-box-yellow-light font-semibold leading-tight mt-3">
            {{ currentSlide.title }}
          </h2>
        </div>
      ...
      <div class="grid grid-cols-3 gap-4">
        <div v-for="slide in slides" :key="slide.title" class="font-medium ">
          ...
          <div class="my-4 text-xl leading-tight">
            <h3 class="text-box-yellow-light">{{ slideNumber }}</h3>
